...
router.get('/reservas', (req, res) => {
    ...
    const query = `
        SELECT 
            ...
            DATE(r.fecha_reserva) as fechaEvento,
            TIME(r.fecha_reserva) as horaInicio,
            ADDTIME(TIME(r.fecha_reserva), '4:00:00') as horaFin
        FROM reserva r
    ...
    connection.query(query, (err, results) => {
        ...
        const reservasFormateadas = results.map(reserva => {
            ...
            return {
                ...
                horaInicio: reserva.horaInicio ? reserva.horaInicio.substring(0, 5) : '',
                horaFin: reserva.horaFin ? reserva.horaFin.substring(0, 5) : '',
...
router.get('/reservas/espacios', (req, res) => {
    ...
    const query = 'SELECT id, nombre, capacidad, costo_base FROM espacio WHERE disponible = true ORDER BY nombre';
...
router.get('/reservas/servicios', (req, res) => {
    ...
    const query = 'SELECT id, nombre, costo FROM servicio WHERE disponible = true ORDER BY nombre';
